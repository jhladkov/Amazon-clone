const translit = (str: string): string => {
	...
	const en =
		"A-a-B-b-V-v-G-g-G-g-D-d-E-e-E-e-E-e-ZH-zh-Z-z-I-i-I-i-I -i-J-j-K-k-L-1-M-m-N-n-0-0-P-p-R-1-S-s-T-t-U-u-F-f-H-h-T S-ts-CH-ch-SH-sh-SCH-sch-'-'-Y-y-'-'-E-e-YU-yu-YA-ya"
			.split('-')
	let res = ''
